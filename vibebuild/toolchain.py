...
_TOOLCHAIN_MARKERS: dict[str, tuple[tuple[str, ...], tuple[str, ...]]] = {
    ...
    "Python": (
        ("python3-devel", "python3-setuptools", "python3-pip", "pyproject-rpm-macros"),
        ("python3dist(", "python(", "python3-"),
    ),
    "Perl": (("perl", "perl-devel", "perl-generators"), ("perl(",)),
    "Ruby": (("ruby", "ruby-devel", "rubygems"), ("rubygem(",)),
    "Node.js": (("nodejs", "npm", "nodejs-devel"), ("npm(", "nodejs-", "nodejs(")),
    "Java": (("java-devel", "java-21-openjdk-devel", "maven-local", "ant"), ("mvn(",)),
    "PHP": (("php", "php-devel", "php-cli"), ("php(", "php-composer(")),
    "R": (("R", "R-core", "R-devel"), ("R-",)),
    "Lua": (("lua", "lua-devel"), ("lua(", "lua-")),
    "Haskell": (("ghc", "cabal-install", "ghc-rpm-macros"), ("ghc-", "haskell-")),
    "OCaml": (("ocaml", "ocaml-findlib"), ("ocaml-", "ocaml(")),
    "Erlang": (("erlang", "erlang-rebar"), ("erlang-",)),
    "Swift": (("swift-lang",), ()),
    ".NET": (("dotnet", "dotnet-sdk"), ("dotnet-",)),
    "CMake": (("cmake",), ("cmake(",)),
